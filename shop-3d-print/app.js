...
function renderCart() {
  ...
  // Ricalcola comunque totale/conteggio anche se il carrello ha voci (il ciclo sopra
  // valorizza total/count solo quando cart.length > 0, che e' l'unico caso rilevante)
...
// Se si arriva da un'altra pagina con ?openCart=1 (es. click su "Carrello" dalla Home),
// apre subito il pannello del carrello.
